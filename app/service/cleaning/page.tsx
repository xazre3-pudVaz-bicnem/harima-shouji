          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <div className="space-y-5 text-gray-600" style={{ fontSize: '1.0625rem', lineHeight: '2.1' }}>
                ...
                <p>店舗クリーニングは、退去時・開業前だけでなく、定期的なメンテナンスとしても重要です。特に厨房・ダクト・エアコンは、適切なクリーニングを行わないと衛生問題や設備の劣化につながります。播磨商事では専門知識を持つスタッフが、店舗の用途・設備状況に合わせたクリーニングを実施します。</p>
                <p>フランチャイズ本部様・多店舗展開企業様の場合、複数店舗のクリーニングを一括で手配できることがメリットです。退去・原状回復工事とクリーニングを同時に依頼することで、工期短縮とコスト削減を実現します。播磨商事にまとめてお任せいただくことで、複数業者への発注が不要になります。</p>
              </div>
            </div>
