...
const reasons = [
  { title: '退去・開業前・改装後すべてに対応', description: '退去・開業前・改装後と、あらゆる場面のクリーニングに対応します。' },
  { title: '厨房・ダクト専門クリーニング', description: '厨房機器・排気ダクト・エアコンの専門クリーニングに対応します。' },
  { title: '原状回復工事との同時対応', description: '原状回復工事と同時にクリーニングを実施でき、工期短縮とコスト削減を実現します。' },
  { title: '複数店舗の一括手配', description: '複数店舗のクリーニングをまとめてご依頼いただけます。' },
]
...
const faqs = [
  ...
  { q: '厨房・業務用厨房のクリーニングに対応できますか？', a: 'はい、業務用厨房の専門クリーニングに対応しています。油汚れ・焦げ付き・カビなど、通常の清掃では対応が難しい汚れも専門の洗剤・機材で対応します。' },
  { q: '退去・引き渡し前のクリーニングのみ依頼できますか？', a: 'はい、クリーニングのみのご依頼にも対応しています。原状回復工事との同時施工をご希望の場合はまとめてお任せいただくことも可能です。' },
  { q: '複数店舗のクリーニングをまとめて依頼できますか？', a: 'はい、複数店舗の一括手配に対応しています。退去スケジュールに合わせて各店舗のクリーニングを調整します。' },
]
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <p className="text-gray-600" style={{ fontSize: '1.0625rem', lineHeight: '2.1' }}>店舗の退去時・開業前・改装後など、さまざまな場面でクリーニングが必要となります。播磨商事では、通常の清掃から厨房・ダクト・エアコンなどの専門クリーニングまで対応しております。</p>
            </div>
