          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <div className="space-y-5 text-gray-600" style={{ fontSize: '1.0625rem', lineHeight: '2.1' }}>
                ...
                <p>店舗の解体・撤去工事は、退去時だけでなく、大規模改装・リノベーションの際にも必要です。内装の全面解体・スケルトン化から、一部の設備撤去まで、工事の内容によって適切な解体方法が異なります。播磨商事では現地の状況を確認した上で、最適な解体プランをご提案します。</p>
                <p>産業廃棄物の適切な処理も、店舗解体・撤去工事で重要なポイントです。廃材・設備・機器の処分には産業廃棄物処理業者との連携が必要ですが、播磨商事では産廃処理まで一括して対応します。複数店舗の解体・撤去をまとめてご依頼いただくことで、工程管理とコストを効率化できます。</p>
              </div>
            </div>
