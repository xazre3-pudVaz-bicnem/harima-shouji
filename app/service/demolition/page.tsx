...
const reasons = [
  { title: '解体から廃材処分まで一括対応', description: '内装解体・設備撤去・廃材処分・産廃処理まで一括してお引き受けします。' },
  { title: '短工期・夜間施工に対応', description: '退去日程に合わせた短工期施工・深夜施工にも対応しています。' },
  { title: 'スケルトン工事の実績多数', description: '内装を完全にスケルトン状態に戻す解体工事の実績が豊富です。' },
  { title: '複数店舗の一括解体に対応', description: '複数店舗の解体工事を一括手配し、工程管理から廃材処分まで統一対応します。' },
]
...
const steps = [
  { number: '01', title: 'ご相談・ヒアリング', description: '解体範囲・退去日程・スケジュール要件をお聞きします。' },
  { number: '02', title: '現地調査・見積', description: '対象店舗に伺い、廃材処分費用を含む詳細な見積書を提出します。' },
  { number: '03', title: '工程確認・着工準備', description: '退去日程に合わせた工程表を作成します。' },
  { number: '04', title: '解体・撤去工事', description: '工程表に沿って解体を進め、廃材を適切に分別・処分します。' },
...
const faqs = [
  ...
  { q: 'スケルトン化（全面解体）から新装工事まで一括で依頼できますか？', a: 'はい、解体・撤去から新規内装工事まで一括してお任せいただけます。業者の調整が不要になり、工期短縮と管理コストの削減が可能です。' },
  { q: '産業廃棄物の処分も対応できますか？', a: 'はい、解体・撤去工事で発生する廃材・設備・機器の産廃処理にも対応しています。適切な処理業者と連携して対応します。' },
  { q: '複数店舗の解体工事をまとめて依頼できますか？', a: 'はい、複数店舗の解体・撤去をまとめてご依頼いただけます。退去スケジュールに合わせた工程管理で、複数店舗を並行して対応します。' },
]
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <p className="text-gray-600" style={{ fontSize: '1.0625rem', lineHeight: '2.1' }}>退去時の内装解体は、解体業者・産廃業者への個別発注が必要なケースが多く、スケジュール管理や費用確認に時間がかかります。特に複数店舗の退去が重なる時期は、担当者への負担が集中します。</p>
            </div>
