          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <div className="space-y-5 text-gray-600" style={{ fontSize: '1.0625rem', lineHeight: '2.1' }}>
                ...
                <p>店舗のクロス（壁紙）は、日常的な使用による汚れや傷み、たばこの煤けなど、時間の経過とともに状態が劣化します。特に飲食店・美容室・小売店では、顧客への印象に直結するため、定期的なクロスの張替えが必要です。播磨商事では部分補修から全面張替えまで、店舗の状況に合わせた対応を提案します。</p>
                <p>複数店舗を展開する法人様の場合、店舗ごとのクロス状態を把握し、張替えのタイミングを調整することが課題になります。播磨商事では、複数店舗のクロス張替えをまとめてご依頼いただくことで、スケジュール管理と発注コストを削減できます。夜間施工・短工期対応により、店舗の営業への影響も最小限に抑えます。</p>
              </div>
            </div>
