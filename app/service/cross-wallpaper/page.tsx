...
const reasons = [
  { title: '夜間・短工期施工に対応', description: '深夜施工・翌朝完了が必要な案件も対応しています。' },
  { title: '部分補修から全面張替えまで', description: '壁の一部補修から店舗全体のクロス全面張替えまで対応します。' },
  { title: '豊富な素材・カラーから選択', description: '店舗のコンセプトに合わせたクロス素材・カラーをご提案します。' },
  { title: '複数店舗の一括手配', description: '複数店舗のクロス張替えをまとめてご依頼いただけます。' },
]
...
const faqs = [
  ...
  { q: 'クロスの一部だけ張替えることは可能ですか？', a: 'はい、部分補修にも対応しています。ただし、既存クロスとの色・柄の違いが出る場合がありますので、現地を確認した上でご提案します。' },
  { q: '夜間施工・休日施工は可能ですか？', a: 'はい、営業中店舗の改装や深夜施工・翌朝完了が必要な案件にも対応しています。スケジュールをご確認の上、対応可否をお伝えします。' },
  { q: '複数店舗のクロス張替えをまとめて依頼できますか？', a: 'はい、複数店舗をまとめてご依頼いただくことで、工程管理と費用を効率化できます。各店舗の状態を確認した上で、最適なスケジュールをご提案します。' },
]
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <p className="text-gray-600" style={{ fontSize: '1.0625rem', lineHeight: '2.1' }}>壁紙・クロスは店舗の印象を大きく左右します。汚れや傷みが目立つクロスはお客様・従業員の心証に影響します。播磨商事では、部分的な補修から店舗全体の張替えまで、ご要望に合わせて柔軟に対応いたします。</p>
            </div>
