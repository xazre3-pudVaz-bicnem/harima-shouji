...
const reasons = [
  { title: '退去立会いに代わりに対応', description: '播磨商事の担当者がオーナー・管理会社との退去立会いに対応します。' },
  { title: '過剰請求への交渉サポート', description: '過剰な原状回復費用の請求に対して交渉サポートを行います。' },
  { title: '複数店舗の退去を一元管理', description: '複数店舗の退去予定をまとめてスケジュール管理します。' },
  { title: '退去後の工事もまとめて依頼', description: '退去立会い後の原状回復工事・クリーニングもそのままご依頼いただけます。' },
]
...
const faqs = [
  ...
  { q: '退去立会いの代行のみ依頼できますか？', a: 'はい、立会い代行のみのご依頼にも対応しています。立会い後に原状回復工事・クリーニングが必要な場合は、そのままご依頼いただくことも可能です。' },
  { q: '原状回復費用の交渉もサポートしてもらえますか？', a: 'はい、退去立会い代行と合わせてオーナー・管理会社との原状回復費用の交渉サポートを行います。過剰な請求がある場合は、適正化に向けて対応します。' },
  { q: '複数店舗の退去をまとめて依頼できますか？', a: 'はい、複数店舗の退去対応を一括してお任せいただけます。各店舗の退去スケジュールを整理し、立会い・工事・クリーニングをまとめて管理します。' },
]
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <p className="text-gray-600" style={{ fontSize: '1.0625rem', lineHeight: '2.1' }}>店舗・テナントの退去時には、オーナーや管理会社との立会い・原状回復の確認・費用の調整など多くの対応が必要です。特に複数店舗を管理するご担当者様にとって、これらの対応は大きな負担となります。</p>
            </div>
