          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <div className="space-y-5 text-gray-600" style={{ fontSize: '1.0625rem', lineHeight: '2.1' }}>
                ...
                <p>店舗・テナントの退去は、担当者様にとって多くの手間と時間がかかります。退去立会いの日程調整から始まり、オーナー・管理会社との原状回復交渉、工事業者の手配まで、すべてを自社で管理することは大変です。播磨商事の退去立会いサポートでは、担当者様の代わりにこれらすべてを代行します。</p>
                <p>特に、複数店舗の退去が重なる場合は管理が複雑になります。播磨商事では複数店舗の退去スケジュールを一元管理し、各店舗の立会い・交渉・工事を並行して進めます。フランチャイズ本部様・多店舗展開企業様の退去対応をまとめてお任せください。</p>
              </div>
            </div>
