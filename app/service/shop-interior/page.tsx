...
const reasons = [
  { title: 'FC仕様統一施工に対応', description: 'フランチャイズ本部の内装仕様書・設計図面をもとに、ブランドの統一感を保ちながら複数店舗の施工を管理します。' },
  { title: '短工期・夜間施工に対応', description: 'オープン日が決まっている新規出店や、営業中店舗の改装でも、夜間・短工期施工で対応します。' },
  { title: '設計から施工まで一括対応', description: '内装デザイン・設計・施工・設備工事まで一括してご依頼いただけます。複数業者の調整が不要になります。' },
  { title: '複数店舗の工程管理', description: '複数店舗の内装工事を同時進行で管理し、工程表を共有します。FC本部様の事業拡大をサポートします。' },
  { title: '東京・関東圏全域対応', description: '東京23区をはじめ、神奈川・埼玉・千葉・茨城など関東圏全域で施工対応しています。' },
  { title: '施工後のアフターサポート', description: 'オープン後の不具合対応・追加工事・原状回復まで、長期にわたってサポートします。' },
]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div>
              ...
              <div className="space-y-5 text-gray-600" style={{ fontSize: '1.0625rem', lineHeight: '2.1' }}>
                <p>フランチャイズ本部様や多店舗展開企業様にとって、店舗ごとの内装工事を個別に発注する手間は大きな負担です。業者選定・工程管理・品質確認を繰り返すことで、事業展開のスピードが落ちてしまうケースも少なくありません。</p>
                <p>播磨商事では、FC仕様統一施工・複数店舗の工程管理・短工期対応を強みとしており、新規出店から改装リノベーションまで一括してお引き受けします。</p>
                <p>店舗内装工事は単なる「内装を作る」作業ではなく、ブランドの世界観を空間で表現することでもあります。播磨商事では、フランチャイズ仕様書に基づいた統一施工から、独自デザインの新規出店まで、店舗コンセプトに沿った内装工事を提供します。</p>
                <p>複数店舗を展開する法人様にとって、施工品質のばらつきは重大な問題です。播磨商事では各店舗の施工に同一の品質基準を適用し、チェーン店・フランチャイズ店舗全体での統一感を実現します。東京・関東圏の店舗内装工事はお気軽にご相談ください。</p>
              </div>
              {/* Pull quote */}
              <blockquote className="mt-8 border-l-4 border-amber-400 pl-6 italic text-gray-700" style={{ fontSize: '1.0625rem', lineHeight: '2' }}>
                「工期を守ることが、お客様の信頼を守ることです。スピードと品質を、妥協せず両立します。」
              </blockquote>
            </div>
          </div>
        </div>
