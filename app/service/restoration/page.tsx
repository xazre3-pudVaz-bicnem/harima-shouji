...
const reasons = [
  { title: '退去立会い代行で担当者負担を軽減', description: '退去立会いに担当者が立ち会う必要がなくなります。オーナー・管理会社との立会いから交渉まで代行します。' },
  { title: '過剰費用の適正化をサポート', description: 'オーナーから請求される原状回復費用が適正かどうかを確認し、過剰な請求に対して交渉サポートを行います。' },
  { title: '複数店舗の退去を一元管理', description: '複数店舗の退去スケジュールを工程表にまとめ、担当者様が個別対応する手間を省きます。' },
  { title: '解体から復旧まで一括対応', description: '内装解体・撤去・クロス復旧・床復旧・クリーニングまで、原状回復に必要なすべての工事を一括でお引き受けします。' },
]
...
const steps = [
  { number: '01', title: 'お問い合わせ', description: 'まずはお電話・メールフォームにてご連絡ください。退去予定日・店舗数・エリアをお伝えいただくとスムーズです。' },
  { number: '02', title: '現地調査・ヒアリング', description: '対象店舗に伺い、現況確認と原状回復範囲のヒアリングを行います。退去立会いの代行も含めてご相談いただけます。' },
  { number: '03', title: '見積・工程提案', description: '原状回復費用の見積書と工程表をご提出します。オーナー提示の見積との比較・交渉サポートも対応します。' },
  { number: '04', title: '退去立会い（代行）', description: '退去立会いを代行し、オーナー・管理会社との確認・交渉をサポートします。過剰請求があれば適正化を図ります。' },
  { number: '05', title: '原状回復工事', description: '解体・撤去・クロス復旧・床復旧・クリーニングを実施します。工事完了後に写真・報告書を提出します。' },
]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <div className="space-y-5 text-gray-600" style={{ fontSize: '1.0625rem', lineHeight: '2.1' }}>
                <p>店舗・テナントの退去時には、退去立会い・原状回復の確認・費用調整など、多くの対応が必要です。特にフランチャイズ本部様や多店舗運営会社様にとって、複数店舗の退去対応は大きな負担となります。</p>
                <p>播磨商事では、退去立会い代行・解体工事・クロス・床材の復旧・設備の撤去・オーナーとの交渉サポートまで、原状回復に関わるすべての対応を一括してお引き受けします。</p>
                <p>過剰な原状回復費用の請求を適正化するためのサポートも行っており、担当者様の費用負担軽減にも貢献します。</p>
                <p>店舗・テナントの退去時に多くの担当者様が直面するのが、原状回復費用の問題です。オーナー・管理会社からの原状回復請求が適正かどうかを確認し、過剰な請求がある場合は交渉サポートを行います。播磨商事では退去立会い代行から原状回復工事・クリーニングまで一括して対応します。</p>
                <p>複数店舗の退去が重なる時期は、担当者様の管理負担が増大します。播磨商事では複数店舗の退去スケジュールを一元管理し、各店舗の退去立会い・原状回復工事を同時並行で進めます。フランチャイズ本部様・多店舗展開企業様の退去管理をまとめてお任せください。</p>
              </div>
            </div>
