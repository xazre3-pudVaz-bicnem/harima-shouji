  ...
  return (
    <div style={{ background: '#FAFAF8' }}>
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 2rem' }}>
          ...
          <dl>
            {companyData.map(({ label, value }) => (
              <div key={label} style={{ display: 'grid', gridTemplateColumns: '8rem 1fr', gap: '1.5rem', padding: '1.375rem 0', borderBottom: '1px solid #F0EFEC' }}>
      ...
      <section style={{ paddingTop: '5rem', paddingBottom: '7rem', background: '#FFFFFF' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 2rem' }}>
          <div style={{ borderTop: '1px solid #F0EFEC', paddingTop: '4rem' }}>
            ...
            <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'flex-start', marginBottom: '2rem' }}>
              ...
              <div style={{ paddingTop: '0.25rem' }}>
                ...
                <div style={{ fontSize: '0.75rem', color: '#9CA3AF', marginTop: '4px' }}>代表取締役</div>
              </div>
            </div>
      ...
      <section style={{ paddingTop: '7rem', paddingBottom: '7rem', background: '#F5F4F0' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 2rem' }}>
          ...
          <p style={{ fontSize: '0.8125rem', color: '#9CA3AF', marginBottom: '2.5rem' }}>平日 9:00〜18:00</p>
          <div style={{ background: '#E5E3DF', aspectRatio: '16/7', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
